...
class SliderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return (_controller.isLoadingBanners.value) ? SizedBox(
      height: 150,
      width: double.infinity,
      child: Center(
        child: SpinKitFadingCircle(color: colorScheme.background,size: 24,),
      ),
    ) : (_controller.banners.isNotEmpty) ? Column(
      children: [
        CarouselSlider.builder(
          ...
          options: CarouselOptions(
              ...
              onPageChanged: (index, reason) {
                _controller.currentCarouselIndex.value =
                    index;
              }),
        ),
